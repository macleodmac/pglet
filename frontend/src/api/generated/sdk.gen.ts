 ...
 */
export const aiSuggestions = <ThrowOnError extends boolean = false>(options?: Options<AiSuggestionsData, ThrowOnError>) => (options?.client ?? client).get<AiSuggestionsResponses, unknown, ThrowOnError>({ url: '/api/ai/suggestions', ...options });
